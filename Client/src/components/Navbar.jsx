            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        ...
                        <Link to="/register" className="px-6 py-2.5 bg-primary text-white font-semibold rounded-custom shadow-lg shadow-blue-500/30 hover:bg-blue-600 transition-all">Register</Link>
                    </div>
